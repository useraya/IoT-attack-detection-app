...
with st.sidebar:
    ...
    **Capabilities:**
    ...
    st.write("**Student:** [Your Name]")
    st.write("**Institution:** EHTP GIS")
...
if model is None:
    ...
    with tab2:
        ...
        - **Dataset Source:** [RT-IoT2022 UCI Repository](https://archive.ics.uci.edu/dataset/942/rt-iot2022)
        - **Institution:** EHTP - École Hassania des Travaux Publics
        - **Program:** GIS - Data Science
...
<div style='text-align: center; color: #666; padding: 2rem 0;'>
    <p>IoT Attack Detection System | EHTP GIS Data Science | 2025-2026</p>
    <p>Developed by [Your Name] | Mini-projet N°2</p>
</div>
""", unsafe_allow_html=True)